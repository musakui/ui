...
/**
 * Get the previous and next siblings of a node.
 *
 * @param {Node} node the reference node
 * @returns {[prev: ChildNode | null, next: ChildNode | null]}
 */
export const siblings = (node) => [node.previousSibling, node.nextSibling]
